        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('\$${state.totalPrice.toStringAsFixed(2)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ],
          ),
      ...
      if (user.phone == null || user.phone!.isEmpty || user.address == null) {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text('Please add your phone number and address before checkout.'),
            actions: [
              TextButton(
